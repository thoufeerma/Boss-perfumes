...
import { updateAccountDetails } from "@/app/account/details/actions";
...
export function AccountDetailsForm({ data }: { data: AccountData }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-xl">
      ...
      {success && <div className="p-3 bg-green-50 text-green-600 text-sm border border-green-200">Account details updated successfully!</div>}
      ...
      {/* Password reset UI can be linked here or implemented as a separate form */}

      <button
        type="submit"
        disabled={isPending}
        className="bg-[#111111] text-white py-3 px-8 text-sm font-medium tracking-widest uppercase hover:bg-black transition-colors disabled:opacity-70 mt-4"
      >
